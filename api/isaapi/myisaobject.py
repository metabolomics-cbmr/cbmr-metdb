...
def create_descriptor(session):
    ...
    investigation.title = "A Test ISA Investigation"
    ...
    #print("Prototype sample", prototype_sample.id)
    ...
    #assay.to_sql(session).update()
    #print(investigation)
    # print(study)
    #investigation.to_sql(session).update()
    investigation.to_sql(session)
    #session.commit()
...
if __name__ == '__main__':
    print(create_descriptor(session))  # print the result to stdout