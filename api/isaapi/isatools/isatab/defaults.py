...
# 20230713 added regex to accept optional space in Comment label 
# the test i_investigation.txt file provided had a space after 'Comment' label 
# the conversion program failed reporting the error of unexpected space
# after discussion with Lawrence, allowed one space after 'Comment'. Added '\s?' belowin _RX_COMMENT
_RX_COMMENT = compile(r'Comment\s?\[(.*?)\]')
