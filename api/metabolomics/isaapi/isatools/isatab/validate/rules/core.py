...
from metabolomics.isaapi.isatools.isatab.defaults import NUMBER_OF_STUDY_GROUPS
from metabolomics.isaapi.isatools.isatab.load import load_table
from metabolomics.isaapi.isatools.isatab.validate.rules.defaults import (
...
class ISAStudyValidator:
    ...
    def __init__(self,
        ...
        #print("ISATabStudyValidato - befor eprotocol_namesr")


        protocol_names = self.params['investigation_df']['s_protocols'][study_index]['Study Protocol Name'].tolist()
        #print("ISATabStudyValidato - lenght of ptotocoal names ", protocol_names.length)
...
class ISAAssayValidator:
    ...
    def __init__(self,
        ...
        if assay_filename != '':
            ...
            #print('Self param cobnfig',  self.params['config'])
