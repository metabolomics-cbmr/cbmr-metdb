...
from metabolomics.isaapi.isatools.isatab.load import read_investigation_file
from metabolomics.isaapi.isatools.isatab.defaults import _RX_COMMENT, default_config_dir, log
from metabolomics.isaapi.isatools.isatab.validate.store import validator as message_handler
from metabolomics.isaapi.isatools.isatab.validate.rules.core import (
...
def validate(fp: TextIO,
    ...
    """
    #print("Inside isatab.valdate start")
    if not log_level:
        log.disabled = True
    ...
    try:
        ...
        #print("After load_investigation")
        params = {
