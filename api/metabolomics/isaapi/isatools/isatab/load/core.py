...
from metabolomics.isaapi.isatools.isatab.load.read import read_tfile, read_investigation_file
from metabolomics.isaapi.isatools.isatab.load.ProcessSequenceFactory import ProcessSequenceFactory
from metabolomics.isaapi.isatools.isatab.defaults import _RX_COMMENT, log
from metabolomics.isaapi.isatools.isatab.utils import strip_comments
from metabolomics.isaapi.isatools.model import (
    OntologyAnnotation,
    Publication,
    Person,
    Comment,
