...
class OntologyAnnotation(Commentable, Identifiable):
    ...
    def __init__(self,
        ...
        #print(" Ontology annotation id before ->  ", id_)
        self.id = id_
        #print(" Ontology annotation id after ->  ", self.id)
    ...
    def from_dict(self, ontology_annotation):
        #print("Ontology annotation from_dict  before ", self.id)

        self.id = ontology_annotation.get('@id', '')
        #print("Ontology annotation from_dict after ", self.id)
