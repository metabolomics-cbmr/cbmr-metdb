from metabolomics.isaapi.isatools.database.models.comment import (
    CommentModel as Comment, Comment as CommentTable, make_comment_methods
)
from metabolomics.isaapi.isatools.database.models.publication import (
    PublicationModel as Publication, Publication as PublicationTable, make_publication_methods
)
from metabolomics.isaapi.isatools.database.models.investigation import (
    InvestigationModel as Investigation, Investigation as InvestigationTable, make_investigation_methods
)
from metabolomics.isaapi.isatools.database.models.study import (
    StudyModel as Study, Study as StudyTable, make_study_methods
)
from metabolomics.isaapi.isatools.database.models.ontology_annotation import (
