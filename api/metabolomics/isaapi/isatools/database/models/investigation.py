...
from metabolomics.isaapi.isatools.model import Investigation as InvestigationModel
from metabolomics.isaapi.isatools.database.models.relationships import investigation_publications, investigation_ontology_source
