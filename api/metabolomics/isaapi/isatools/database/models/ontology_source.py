...
from metabolomics.isaapi.isatools.model import OntologySource as OntologySourceModel
from metabolomics.isaapi.isatools.database.models.relationships import investigation_ontology_source
...
def make_ontology_source_methods() -> None:
    ...
    def to_sql(self, session) -> OntologySource:
        ...
        #print('In ontology_source  1', self.name)
        if ontology_source:
            return ontology_source

        #print('In ontology_source  2', self.name)
