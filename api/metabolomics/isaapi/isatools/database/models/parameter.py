...
from metabolomics.isaapi.isatools.model import ProtocolParameter as ParameterModel
from metabolomics.isaapi.isatools.database.models.relationships import protocol_parameters
