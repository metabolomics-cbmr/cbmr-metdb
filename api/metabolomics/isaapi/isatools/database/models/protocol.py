...
from metabolomics.isaapi.isatools.model import Protocol as ProtocolModel
from metabolomics.isaapi.isatools.database.models.relationships import study_protocols, protocol_parameters
