...
from metabolomics.isaapi.isatools.model import DataFile as DataFileModel
from metabolomics.isaapi.isatools.database.models.relationships import assay_data_files
