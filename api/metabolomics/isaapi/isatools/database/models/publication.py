...
from metabolomics.isaapi.isatools.model import Publication as PublicationModel
from metabolomics.isaapi.isatools.database.models.relationships import investigation_publications, study_publications
