...
from metabolomics.isaapi.isatools.graphQL.custom_scalars import DateTime, StringOrInt
from metabolomics.isaapi.isatools.graphQL.inputs import (
    AssayParameters,
...
from metabolomics.isaapi.isatools.graphQL.utils.search import (
    search_assays,
...
class Process(ObjectType):
    from metabolomics.isaapi.isatools.graphQL.unions import ProcessInputs, ProcessOutputs
