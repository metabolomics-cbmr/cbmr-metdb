...
const ISADataListRow = ({ index, investigationId, title, description }) => {

  // const history = useHistory();
  // const navigateToRecords = () => {
  //   var u =  ROUTES.ISADATA_RETRIEVAL.replace(':id', investigationId) ;
  //   console.log(u)
...
const ISAData= ( {isaDataDetails} : {isaDataDetails:ISADataDetails[]} ) => {
    ...
    <div className="d-flex flex-wrap">
      ...
      <Card className="p-0 w-100">
        <table className="w-100">
          ...
          {isaDataDetails ?  isaDataDetails.map((item, i) => (
                  <ISADataListRow 
                    index={i}
...
const ISADataDetailsLayout = (isaDataDetails) => {
  return (
    <ISAData isaDataDetails = {isaDataDetails} />
...
export default ISADataDetailsLayout;
