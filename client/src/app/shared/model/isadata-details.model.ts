/**
 * ISA Data Details  for Investigation, Study, Assay
 */
export interface ISADataDetails {
  mst: Mst;
}

export interface ISAStudyDetails {
  mst: StudyMst;
}

export interface ISAAssayDetails {
  mst: AssayMst
}

export interface ISAInvResultsDetails {
  mst: InvResults
}

export interface ISASampleDetails {
  mst: Samples 
}
...
export interface Dets {
  
}


export interface InvResults {
  assay_id: number,
  sample_name: string, 
  compound_name: string,
  intensity: number,
